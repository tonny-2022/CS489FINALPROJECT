...
using ItemMatchService.mapping;
using ItemMatchService.repository;
using ItemMatchService.service;
...
builder.Services.AddDbContext<ItemMatchDbContext>(options =>
				 options.UseNpgsql(builder.Configuration.GetConnectionString("ItemMatchServiceConnectionString")));
builder.Services.AddAutoMapper(typeof(ItemMatchMapping));
builder.Services.AddScoped<ItemMatchRepository, ItemMatchServiceImpl>();
